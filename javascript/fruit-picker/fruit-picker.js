 ...
 * @return void
 */
const FruitPickerSuccess = {"message": "SUCCESS" }
const FruitPickerError = {"message": "ERROR" }
export function onSuccess() {
  notify(FruitPickerSuccess)
}
...
export function postOrder(variety, quantity) {
  ...
  // NOTE: why can't i use onSuccess() and onError() here ?
